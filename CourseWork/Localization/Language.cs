...
namespace CourseWork.Localization
{
    public class Language
    {
        ...
        public Language()
        {
            ...
            Name = CourseWork.Properties.Settings.Default.DefaultLanguage;
        }
        ...
        {
            CourseWork.Properties.Settings.Default.DefaultLanguage = Name;
